...
byte cleanerOn[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x01, 0x01, 0x01, 0x66
};

byte cleanerOff[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x01, 0x00, 0x01, 0x65
};

byte poolLightOn[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x02, 0x01, 0x01, 0x67
};

byte poolLightOff[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x02, 0x00, 0x01, 0x66
};

byte waterFallOn[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x03, 0x01, 0x01, 0x68
};

byte waterFallOff[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x03, 0x00, 0x01, 0x67
};

byte poolOn[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x06, 0x01, 0x01, 0x6B
};

byte poolOff[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x86, 0x02, 0x06, 0x00, 0x01, 0x6A
};
...
uint8_t chlorStep1[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x02, 0x00, 0x00, 0x01, 0x7C
}; // 2% chlorination

uint8_t chlorStep2[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x05, 0x00, 0x00, 0x01, 0x7F
}; // 5% chlorination

uint8_t chlorStep3[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x0A, 0x00, 0x00, 0x01, 0x84
}; // 10% chlorination

uint8_t chlorStep4[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x0F, 0x00, 0x00, 0x01, 0x89
}; // 15% chlorination

uint8_t chlorStep5[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x14, 0x00, 0x00, 0x01, 0x8E
}; // 20% chlorination

uint8_t chlorStep6[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x19, 0x00, 0x00, 0x01, 0x93
}; // 25% chlorination

uint8_t chlorStep7[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x21, 0x00, 0x00, 0x01, 0x9B
}; // 33% chlorination

uint8_t chlorStep8[] =
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xA5, 0x07, 0x10, 0x20, 0x99, 0x04, 0x01, 0x32, 0x00, 0x00, 0x01, 0xAC
}; // 50% chlorination
...
{
	0x1A, 0x22, 0x23, 0x24
}; // list of Vera VSwitch ID's (in HEX)
			...
			if (client.available())
			{
				...
				if (c == '\n' && currentLineIsBlank)
				{
					...
					if (StrContains(HTTP_req, "/pool/light/on"))
					{
						...
						if (StrContains(HTTP_req, "/pool/light/off"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/clean/on"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/clean/off"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/waterfall/on"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/waterfall/off"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/circulate/on"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/circulate/off"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/xively/update"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/getsetpoint"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/getsalinity"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/error"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/water/temp"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/pump/rpm"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/pump/watts"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/light/state"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/avr/uptime"))
						{
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/1"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/2"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/3"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/4"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/5"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/6"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/7"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/chlorinator/set/8"))
						{
							client.println(F("Content-Type: text/plain"));
							client.println(F("Connection: close"));
							client.println();
						...
						if (StrContains(HTTP_req, "/pool/status"))
						{
							rawUptime = (millis() / 1000);
							...
							if (saltPct > saltSetpoint)
							{
								...
								if (saltPct < saltSetpoint && (circulationState > 0 || waterfallState > 0 || cleanerState > 0))
								{
						...
						if (StrContains(HTTP_req, "/avr/api/usage"))
						{
							client.println(F("HTTP/1.1 200 OK"));
							client.println(F("Content-Type: text/html"));
							client.println(F("Connnection: close"));
...
void printFrameData(uint8_t * buffer, byte len)
{
	...
	if (sumOfBytesInChkSum == chkSumValue)
	{
		if (bufferOfBytes[5] == 0x1D)
		{
			...
			if (bufferOfBytes[2] == 0xF && bufferOfBytes[3] == 0x10 && bufferOfBytes[24] == 0x2D && bufferOfBytes[25] == 0x2D)
			{
				oldSaltSetpoint = saltSetpoint;
				...
				if (saltStateLow == 0x81 && saltStateHigh == 0x81)
				{
					...
					if (saltStateLow == 0x81 && saltStateHigh == 0x80)
					{
						saltStateResult = 0x0;
						Serial.println(F("RUNNING - NO ERRORS"));
					}
				else
					if (saltStateLow == 0x80 && saltStateHigh == 0x81)
					{
						saltStateResult = 0x1;
						Serial.println(F("COMM ERROR"));
					}
				else
					if (saltStateLow == 0x80 && saltStateHigh == 0x80)
					{
						saltStateResult = 0x3;
